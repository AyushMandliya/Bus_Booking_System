...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Ayush Mandliya", font='Arial 12 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B080", font='Arial 12 bold', fg='blue').pack()
    ...
    def check_booking_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 28 bold', bg='cyan2', fg='blue4').grid(row=2,column=0,columnspan=12,pady=20)
        Label(root, text="Check Your Booking", font='Arial 22 bold', bg='olivedrab1', fg='dark green').grid(row=3,column=0,pady=20,columnspan=12,padx=600)
    ...
    def add_route_page(self):
        ...
        Button(root, text="Add Route", font='Arial 12 bold', bg='green2', fg='black',command=add_route).grid(row=3, column=7, pady=20, padx=10)
